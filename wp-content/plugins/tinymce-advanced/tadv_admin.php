...
<p>
	<?php _e( 'The toolbars in the Classic Paragraph and Classic blocks are narrower and show on focus. 22222', 'tinymce-advanced' ); ?>
...
if ( ! is_multisite() || current_user_can( 'manage_sites' ) ) {
	...
	<div>
		...
		<p>
			...
			<input type="submit" class="button submit-import" name="tadv-import-settings" value="<?php _e( 'Import Settings', 'tinymce-advanced' ); ?>" />
		</p>
	</div>
	<div>
