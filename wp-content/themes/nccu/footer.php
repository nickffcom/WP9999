<footer>
		...
		<script src="<?php THEM_URL()  ?>/libs/jquery-3.4.1.min.js"></script>
		<script src="<?php THEM_URL()  ?>/libs/bootstrap/js/bootstrap.min.js"></script>
		<script src="<?php THEM_URL()  ?>/js/main.js"></script>
		<div id="fb-root"></div>
        <script async defer crossorigin="anonymous" src="https://connect.facebook.net/en_GB/sdk.js#xfbml=1&version=v16.0" nonce="ePMdh6Iy"></script>
		<?php wp_footer(); ?>
	</body>
</html>