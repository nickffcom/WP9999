...
function custom_page_link( $permalink, $post ) {
    // Lấy đường dẫn đến trang chủ
    $home_url = home_url();
  
    // Lấy tên slug của trang
    $page_slug = $post->post_name;
    echo 44444444;
    // Tạo liên kết mới với cấu trúc /page/{slug}
    $new_permalink = $home_url . '/page/' . $page_slug;
...
function prefix_render() {
    echo '<div class="wrap">';
    echo "Content WElcomeeeeeeeeeeeeee";
    echo '</div>';
}
